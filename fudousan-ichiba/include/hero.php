...
<img class="" src="<?php echo get_template_directory_uri(); ?>/images/hero_catch02.png" alt="トップのキャッチフレーズ画像">
                  ...
                  <?php get_template_part('include/kagoshimacity-animation'); ?>
                </div>
                <div class="hero__checkbox">
                  <div class="hero__checkbox-inner">
                  <div class="hero__checkbox-toggle"> </div>
                  </div>
                </div>
...
<?php elseif (is_post_type_archive('property')) : ?>
    ...
    <div class="hero-sub">    
      ...
      <?php elseif (is_tax()||is_singular('property')): ?>
        <?php 
